        ...
        <div class="row justify-content-center align-items-center mb-5">
            <div class="col-10">
                <div class="input-group mb-0">
                    ...
                    <input type="text" v-model="searchInput" class="form-control fs-5 z-0 rounded-end-pill py-3 pe-5"
                        id="home-search-bar" aria-label="Search bar" placeholder="Search..." autocomplete="off"
                        @keyup.enter="search">
                    <button @click="search" class="btn btn-primary z-1" type="button" id="button-search-home">
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" tabindex="-1">
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary rounded-pill" data-bs-dismiss="modal" @click="search">Apply</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            search() {
                ...
                if (this.checkedPrices.length > 0) params.price_range = this.checkedPrices;
