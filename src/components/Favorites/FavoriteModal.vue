<template>
  <div class="modal fade" :id="'favorite-modal-' + id">
    <div
    ...
    >
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <hr />
          <label :for="'favorite-select-' + id" class="form-label mt-2"
            >Select your favorite list</label
          >
          <select
            class="form-select"
            :id="'favorite-select-' + id"
            aria-label="Select your favorite list"
            v-model="favorite"
          >
