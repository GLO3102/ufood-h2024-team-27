  ...
  <div class="container">
    <div class="row d-flex justify-content-center">
      <div class="col-md-10 mt-3 pt-3 pb-5">
        <div class="row z-depth-3 shadow-lg mb-1 mt-3 border border-5 rounded-4 border-primary">
          <div class="col-sm-4 bg-primary rounded-left">
            <div class="card-block text-center text-white">
              <img :src="user.pfp" class="rounded-circle mb-3 mt-5" style="width: 150px" alt="Avatar" />
              <h5 class="mb-2">
              ...
              <i class="fa-solid fa-star w-100 pb-4" style="color: #ffd43b">{{user.rating }}</i>
    ...
    <div class="row d-flex justify-content-center mb-4">
      ...
      <div v-if="state.isActive === false" class="col-8 d-flex justify-content-center align-items-center">
        <button @click="goHome" class="btn btn-primary rounded-4">
          No recents, go back to home page
        </button>
      </div>
      <div v-else class="col-8 d-flex flex-wrap gap-3 justify-content-center align-items-top" id="cards">
        <div :class="['card rounded-4 border-primary-subtle shadow ',{ active: index === 0 }]" style="width: 12em"
             v-for="(restaurant, index) in visitedRestaurantDetails" :key="restaurant.id">
          <img :src="restaurant.pictures[0]" class="card-img-top object-fit-cover rounded-5 p-3" style="width: 100%; height: 12em"
               alt="..." draggable="false" />
